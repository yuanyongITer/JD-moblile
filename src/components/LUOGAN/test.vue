	...
	export default{
		...
		methods:{
			...
			MoreColor(flag,index){
                ...
                if(!flag){
                    document.getElementById(this.dataList[index].id).style.height = 100+"px";
			...
			MoreList(){
				document.getElementById('div_id_Height').style.height = 120+"px";
				document.getElementById('div_id_Height').overflow = "auto";
			}
		}
	}
</script>
